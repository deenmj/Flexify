                    ...
                    {photos.map((p, i) => (
                      <div key={i} className="photo-tag" style={{ display: 'flex', flexDirection: 'column', padding: '10px 12px', border: '1px solid #cbd5e1', borderRadius: '12px', background: '#f8fafc', position: 'relative' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', marginBottom: '4px' }}>
                          ...
                          <button type="button" onClick={() => removeNewPhoto(i)} style={{ background: 'none', border: 'none', color: '#94a3b8', cursor: 'pointer', fontSize: '1.25rem', padding: '0 4px', lineHight: 1 }}>×</button>
                        </div>
