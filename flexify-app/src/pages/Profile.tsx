          ...
          <div className="profile-hero-content">
            ...
            <div className="hero-text-content">
              <h1 className="profile-hero-name" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                {user.name}
                {user.isKycVerified && (
                  <div className="pro-badge animate-pulse" title="KYC Verified User">
              ...
              <div className="profile-badges">
                ...
                {user.isKycVerified && <span className="badge badge-success" style={{ background: 'linear-gradient(45deg, #059669, #10b981)', color: 'white', border: 'none' }}>KYC Verified ✓</span>}
              </div>
            </div>
              ...
              <div className="profile-info-item">
                ...
                <div>
                  ...
                  <span className={`profile-info-value ${user.isKycVerified ? 'text-success' : 'text-danger'}`} style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                    {user.isKycVerified ? <><CheckCircle size={14} color="#10b981" /> KYC Verified</> : user.verificationStatus === 'pending' ? 'Pending Review' : 'Not Verified'}
                  </span>
                </div>
              </div>
