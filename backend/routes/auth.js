...
router.get("/verify-email/:token", async (req, res) => {
  ...
  const frontendUrl = process.env.FRONTEND_URL || (process.env.NODE_ENV === 'production' ? "https://flexify-production.up.railway.app" : "http://localhost:5173");
...
router.post("/forgot-password", forgotPasswordLimiter, async (req, res) => {
  ...
  try {
    ...
    const frontendUrl = process.env.FRONTEND_URL || "https://flexify-production.up.railway.app";
